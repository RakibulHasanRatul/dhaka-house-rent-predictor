...
Another surprising aspect is that the scratch-built model is **almost 1.9 times faster** than Scikit-learn's implementation for this specific dataset, as shown in the [speedtest.md](./speedtest.md) file.
