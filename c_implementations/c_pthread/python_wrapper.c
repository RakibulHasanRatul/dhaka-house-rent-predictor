...
static struct PyModuleDef module = {PyModuleDef_HEAD_INIT, "c_pthread",
                                    "C implementation of linear regression model with pthread", -1,
                                    methods};

PyMODINIT_FUNC PyInit_c_pthread(void) { return PyModule_Create(&module); }
